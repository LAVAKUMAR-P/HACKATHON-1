...
async function getUser(){
    ...
    try{
        ...
        userList.innerHTML=`<div style="color:red;font-size: 30px;font-weight:bold;">please enter right anime name</div>
        <div style="color:red;font-size: 30px;font-weight:bold;">some examples
               <ul>
